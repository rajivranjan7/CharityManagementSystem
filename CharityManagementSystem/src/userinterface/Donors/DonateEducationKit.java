 ...
 */
public class DonateEducationKit extends javax.swing.JFrame {
    ...
    /**
     * Creates new form DonateEducationKit
     */
    public DonateEducationKit(UserAccount account, Network network, Enterprise enterprise) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Donate Education Kit");
        jPanel1.add(jLabel1);
        jLabel1.setBounds(200, 60, 361, 47);
        ...
        comboBoxOrg.setBounds(380, 170, 260, 50);
        ...
        jPanel1.add(jLabel2);
        jLabel2.setBounds(80, 170, 250, 40);
        ...
        jPanel1.add(jLabel3);
        jLabel3.setBounds(160, 260, 170, 40);

        btnDonate.setBackground(new java.awt.Color(255, 255, 255));
        btnDonate.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        ...
        btnDonate.setBounds(440, 370, 150, 130);
        ...
        txtQuantity.setBounds(380, 260, 260, 50);
        ...
        jButton2.setBounds(20, 9, 100, 40);

        getContentPane().add(jPanel1);
        jPanel1.setBounds(0, -5, 750, 610);
    ...
    private void btnDonateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDonateActionPerformed
        ...
        if (txtQuantity.getText().isEmpty()) {
         ...
         EducationWelfareKitInventoryRequest educationWelfareKitRequest = new EducationWelfareKitInventoryRequest();
         educationWelfareKitRequest.setQuanity(Integer.parseInt(txtQuantity.getText()));
         educationWelfareKitRequest.setDonorName(account.getEmployee().getName());
         educationWelfareKitRequest.setDonorType(account.getRole().toString());
         educationWelfareKitRequest.setStatus("Donated");
         educationWelfareKitRequest.setRequestDate(new Date());
         educationWelfareKitRequest.setEnterprise(enterprise);
         educationWelfareKitRequest.setNetwork(network);
         educationWelfareKitRequest.setOrgType(type);
            for (Enterprise enterprise : network.getEnterpriseDirectory().getEnterpriseList()) {
                if(enterprise.getEnterpriseType() == Enterprise.EnterpriseType.InventoryManagementDirectory){
                    for(Organization org : enterprise.getOrganizationDirectory().getOrganizationList()){
                        ...
                        org.getWorkQueue().getWorkRequestList().add(educationWelfareKitRequest);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DonateEducationKit.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DonateEducationKit( account,  network, enterprise).setVisible(true);
            }
        });
    }
        ...
        for(Enterprise e : network.getEnterpriseDirectory().getEnterpriseList()){
            if(e.getEnterpriseType().toString().equals(Enterprise.EnterpriseType.CharityDirectory.toString())){
                for(Organization org : e.getOrganizationDirectory().getOrganizationList()){
                    if(org.getType().toString().equals(Organization.Type.EducationCharityOrganization.toString()))
