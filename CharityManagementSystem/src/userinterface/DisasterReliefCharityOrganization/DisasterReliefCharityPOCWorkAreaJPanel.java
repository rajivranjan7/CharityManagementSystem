...
public class DisasterReliefCharityPOCWorkAreaJPanel extends javax.swing.JPanel {
    ...
    private DisasterReliefCharityOrganization disasterWelfareCharityOrg;
     ...
     */
    public DisasterReliefCharityPOCWorkAreaJPanel(UserAccount account, Enterprise enterprise, Organization organization, Network network) {
        initComponents();
        this.account =account;
        this.enterprise = enterprise;
        this.organization =organization;
        this.network = network;
        this.disasterWelfareCharityOrg = (DisasterReliefCharityOrganization) organization;
        txtTotalFunds.setText(String.valueOf(disasterWelfareCharityOrg.getTotalFunds()));
            ...
            if(e.getEnterpriseType() == EnterpriseType.InventoryManagementDirectory){
                for(Organization org : e.getOrganizationDirectory().getOrganizationList()){
                    if(org.getType() == Organization.Type.DisasterReliefKitInventoryManagementOrganization){
                        this.disasterWelfareInventoryOrg = (DisasterReliefKitInventoryManagementOrganization) org;
                    }}}}
        
        txtTotalKits.setText(String.valueOf(disasterWelfareInventoryOrg.getTotalKits()));
        populateTable();
    }
    ...
    private void initComponents() {
        ...
        jLabelInventoryOverview.setText("Total Donations collected for Disaster Welfare Charity Organization");
        ...
        jLabelTitle.setText("Disaster Welfare Charity Admin");
        ...
        jLabelInventoryOverview1.setText("Total Kits Donations collected for Disaster Welfare Charity Organization");
        ...
        if (selectedRow >= 0) {
            ...
            if (request.getStatus().equalsIgnoreCase("Donated")) {
                ...
                if (request instanceof CommerceFinanceRequest) {
                    ...
                    double totalFunds = disasterWelfareCharityOrg.getTotalFunds() + amount;
                    disasterWelfareCharityOrg.setTotalFunds(totalFunds);
                    txtTotalFunds.setText(String.valueOf(disasterWelfareCharityOrg.getTotalFunds()));
                }
        ...
        if (selectedRow >= 0) {
            ...
            if (request.getStatus().equalsIgnoreCase("Completed")) {
                ...
                if (request instanceof DisasterWelfareKitInventoryRequest) {
                    ...
                    int totalKits = disasterWelfareCharityOrg.getTotalKits() + quantity;
                    disasterWelfareCharityOrg.setTotalKits(totalKits);
                    txtTotalKits.setText(String.valueOf(disasterWelfareCharityOrg.getTotalKits()));
                }
                request.setReceiver(account);
                request.setStatus("Completed");
                populateTable();
