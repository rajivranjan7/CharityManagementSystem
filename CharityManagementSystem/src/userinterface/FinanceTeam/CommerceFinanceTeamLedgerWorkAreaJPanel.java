...
public class CommerceFinanceTeamLedgerWorkAreaJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Welcome Finance Ledger ");
        ...
        jScrollPane3.setViewportView(tblKits);
        ...
        if (selectedRow >= 0) {
            ...
            if (request.getStatus().equalsIgnoreCase("Completed")) {
                ...
                if (request instanceof CommerceFinanceRequest) {
                    CommerceFinanceRequest fundRequest = (CommerceFinanceRequest) tblKits.getValueAt(selectedRow, 0);
                }
